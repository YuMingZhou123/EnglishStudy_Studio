...
$lines = @(
    ...
    "- Beta feedback gate check: [open]($(ConvertTo-FileUri (Join-Path $RepoRoot "acceptance\beta-feedback-gate-check.md")))",
    "- Human execution plan: [open]($(ConvertTo-FileUri (Join-Path $RepoRoot "acceptance\first-version-human-plan.md")))",
